...
function MyApp({ Component, pageProps }) {
  ...
  const [musicPacks, setMusicPacks] = useState([
      ...
      { 
        ...
        cover: 'https://i.imgur.com/RI8Isa0.png', // Placeholder - update this with a proper Imgur link
        gumroadLink: 'https://topdjcrates.gumroad.com/l/gzren', // Placeholder - update this with the actual Payhip link
        originalPrice: 30, // Example price, adjust as needed
        discountedPrice: 20, // Example price, adjust as needed
        tracks: [ 
          { id: '17a', title: 'Dancefloor Weapons (short preview)', audioPreview: 'https://audio-hosting.netlify.app/preview danfloor weapons.mp3' } 
          // Add more tracks manually here as you create them
        ] 
      },
  ]);
  ...
  useEffect(() => {
    const showRandomNotification = () => {
      ...
      // Exclude the 'I WANT THEM ALL !' bundle from social proof if you only want single crates shown
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              '@type': 'Organization',
              'name': 'TOP DJ CRATES',
              'url': 'https://www.topdjcrates.com', // Replace with your actual domain when live
              'logo': 'https://www.topdjcrates.com/logo.png', // Replace with the actual URL to your logo
            }),
          }}
        />
