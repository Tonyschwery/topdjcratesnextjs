...
export default function AboutPage() {
  return (
    // This is now purely the page's content.
    // The Header, Footer, and background are all handled by _app.js.
    <>
      <Head>
        <title>Where Do DJs Get Their Music? | The TOP DJ CRATES Story</title>
        <meta
          name="description"
          content="The secret's out. Learn how TOP DJ CRATES became the trusted source for professional DJs to get high-quality, exclusive music and save time."
        />
      </Head>

      <div className="px-4 py-16"> {/* This div provides padding for the content */}
